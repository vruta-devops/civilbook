        ...
        <div class="container-fluid p-0">
            ...
            <div class="header-right d-flex align-itens-center">
                ...
                <div class="input-group search-text search-device-lg" style="width: auto;">
                  <input v-model="keyword" :placeholder="__('messages.search')" aria-expanded="false"
                         class="form-control nav-item dropdown" data-bs-toggle="dropdown" type="text" @keyup="getServiceList">
                    <svg width="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="search-icon">
                      <circle cx="11.7669" cy="11.7666" r="8.98856" stroke="currentcolor" stroke-linecap="round"
