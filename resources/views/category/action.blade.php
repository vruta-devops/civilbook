...
<div class="d-flex justify-content-end align-items-center">
    @if(!$category->trashed())
        ...
        <a class="mr-2" href="{{ route('category.create',['id' => $category->id]) }}" title="{{ __('messages.update_form_title',['form' => __('messages.category') ]) }}"><i class="fas fa-pen text-primary"></i></a>
        @endif
