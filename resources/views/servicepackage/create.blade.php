                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                {{--                                @php--}}
                                {{--                                    $assigned_service_providers = $servicepackage->providers->mapWithKeys(function ($item) {--}}
                                {{--                                    return [$item->provider_id => optional($item->providers)->display_name];--}}
                                {{--                                    });--}}

                                {{--                                    $provider_address = $servicepackage->providers->mapWithKeys(function ($item) {--}}
                                ...
                                <br/>
                                {{ Form::select('provider_address_id[]', [], optional($servicepackage->providers)->pluck('provider_address_id'), [
                                ...
                                <a href="{{ route('provideraddress.create') }}" class=""><i
                                            class="fa fa-plus-circle mt-2"></i> {{ trans('messages.add_form_title',['form' => trans('messages.provider_address')  ]) }}
                                </a>
                            </div>
                        @endif
                        <div class="form-group col-md-4">
    ...
    <script type="text/javascript">
        (function($) {
            ...
            $(document).ready(function(){
                var provider_address_id = "[]";
                var package_type = $("#package_type").val();
                hideShow(package_type);

                providerAddress({{auth()->user()->id}}, provider_address_id);
