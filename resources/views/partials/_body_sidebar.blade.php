...
$menu->add('<span>'.__('messages.chat').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.chat').'</span></span>', ['route' => 'chat'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12.25 1.75V3.25H9.25V1.75H12.25ZM4.75 1.75V6.25H1.75V1.75H4.75ZM12.25 7.75V12.25H9.25V7.75H12.25ZM4.75 10.75V12.25H1.75V10.75H4.75ZM13.75 0.25H7.75V4.75H13.75V0.25ZM6.25 0.25H0.25V7.75H6.25V0.25ZM13.75 6.25H7.75V13.75H13.75V6.25ZM6.25 9.25H0.25V13.75H6.25V9.25Z" fill="#6C757D" />
</svg>')
->data('role', 'admin')
...
$menu->add('<span>'.trans('messages.department').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.department').'</span></span>', ['class' => ''])
...
$menu->departments->add('<span>'.trans('messages.list_form_title',['form' => trans('messages.department')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'department.index'])
...
$menu->departments->add('<span>'.trans('messages.add_form_title',['form' => trans('messages.department')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'department.create'])
    ->data('permission', 'department add')
...
$menu->departments->add('<span>'.trans('messages.list_form_title',['form' => trans('messages.department_type')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'department-types.index'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 4.875C1.3775 4.875 0.875 5.3775 0.875 6C0.875 6.6225 1.3775 7.125 2 7.125C2.6225 7.125 3.125 6.6225 3.125 6C3.125 5.3775 2.6225 4.875 2 4.875ZM2 0.375C1.3775 0.375 0.875 0.8775 0.875 1.5C0.875 2.1225 1.3775 2.625 2 2.625C2.6225 2.625 3.125 2.1225 3.125 1.5C3.125 0.8775 2.6225 0.375 2 0.375ZM2 9.375C1.3775 9.375 0.875 9.885 0.875 10.5C0.875 11.115 1.385 11.625 2 11.625C2.615 11.625 3.125 11.115 3.125 10.5C3.125 9.885 2.6225 9.375 2 9.375ZM4.25 11.25H14.75V9.75H4.25V11.25ZM4.25 6.75H14.75V5.25H4.25V6.75ZM4.25 0.75V2.25H14.75V0.75H4.25Z" fill="#6C757D" />
</svg>')
->data('permission', 'department-types list')
->link->attr(['class' => '']);

//$menu->departments->add('<span>'.trans('messages.list_form_title',['form' => trans('messages.certificates')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'certificates.index'])
//->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
//    <path d="M2 4.875C1.3775 4.875 0.875 5.3775 0.875 6C0.875 6.6225 1.3775 7.125 2 7.125C2.6225 7.125 3.125 6.6225 3.125 6C3.125 5.3775 2.6225 4.875 2 4.875ZM2 0.375C1.3775 0.375 0.875 0.8775 0.875 1.5C0.875 2.1225 1.3775 2.625 2 2.625C2.6225 2.625 3.125 2.1225 3.125 1.5C3.125 0.8775 2.6225 0.375 2 0.375ZM2 9.375C1.3775 9.375 0.875 9.885 0.875 10.5C0.875 11.115 1.385 11.625 2 11.625C2.615 11.625 3.125 11.115 3.125 10.5C3.125 9.885 2.6225 9.375 2 9.375ZM4.25 11.25H14.75V9.75H4.25V11.25ZM4.25 6.75H14.75V5.25H4.25V6.75ZM4.25 0.75V2.25H14.75V0.75H4.25Z" fill="#6C757D" />
//</svg>')
//->link->attr(['class' => '']);
...
$menu->services->add('<span>'.__('messages.pending_list_form_title',['form' => __('messages.service')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'service.pending-service'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 4.875C1.3775 4.875 0.875 5.3775 0.875 6C0.875 6.6225 1.3775 7.125 2 7.125C2.6225 7.125 3.125 6.6225 3.125 6C3.125 5.3775 2.6225 4.875 2 4.875ZM2 0.375C1.3775 0.375 0.875 0.8775 0.875 1.5C0.875 2.1225 1.3775 2.625 2 2.625C2.6225 2.625 3.125 2.1225 3.125 1.5C3.125 0.8775 2.6225 0.375 2 0.375ZM2 9.375C1.3775 9.375 0.875 9.885 0.875 10.5C0.875 11.115 1.385 11.625 2 11.625C2.615 11.625 3.125 11.115 3.125 10.5C3.125 9.885 2.6225 9.375 2 9.375ZM4.25 11.25H14.75V9.75H4.25V11.25ZM4.25 6.75H14.75V5.25H4.25V6.75ZM4.25 0.75V2.25H14.75V0.75H4.25Z" fill="#6C757D" />
</svg>')
->data('permission', 'service list')
...
$menu->services->add('<span>'.__('messages.list_form_title',['form' => __('messages.providerdocument')]).'</span>', ['class' => 'sidebar-layout' ,'route' => 'providerdocument.index'])
...
$menu->add('<span>'.__('messages.wallet_withdraw').'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.wallet_withdraw').'</span></span>', ['route' => 'wallet-withdraw.index'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 16 12" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13.75 3.46V1.75C13.75 0.925 13.075 0.25 12.25 0.25H1.75C0.9175 0.25 0.25 0.925 0.25 1.75V12.25C0.25 13.075 0.9175 13.75 1.75 13.75H12.25C13.075 13.75 13.75 13.075 13.75 12.25V10.54C14.1925 10.2775 14.5 9.805 14.5 9.25V4.75C14.5 4.195 14.1925 3.7225 13.75 3.46ZM13 4.75V9.25H7.75V4.75H13ZM1.75 12.25V1.75H12.25V3.25H7.75C6.925 3.25 6.25 3.925 6.25 4.75V9.25C6.25 10.075 6.925 10.75 7.75 10.75H12.25V12.25H1.75Z" fill="#6C757D" />
    <path d="M10 8.125C10.6213 8.125 11.125 7.62132 11.125 7C11.125 6.37868 10.6213 5.875 10 5.875C9.37868 5.875 8.875 6.37868 8.875 7C8.875 7.62132 9.37868 8.125 10 8.125Z" fill="#6C757D" />
</svg>')
->nickname('wallet_withdraw')
->data('permission', 'wallet list');


$menu->add('Post Job', ['class' => 'category-main'])->data('role', ['admin','provider','demo_admin']);
...
$menu->add('<span>'.trans('messages.list_form_title',['form' => trans('messages.post_job_audio_service')]).'</span><span class="custom-tooltip"><span class="tooltip-text">'.__('messages.post_job').'</span></span>', ['route' => 'service.audio-service-list'])
->prepend('<svg width="15" height="15" class="sidebar-menu-icon" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M17.283,5.549h-5.26V4.335c0-0.222-0.183-0.404-0.404-0.404H8.381c-0.222,0-0.404,0.182-0.404,0.404v1.214h-5.26c-0.223,0-0.405,0.182-0.405,0.405v9.71c0,0.223,0.182,0.405,0.405,0.405h14.566c0.223,0,0.404-0.183,0.404-0.405v-9.71C17.688,5.731,17.506,5.549,17.283,5.549 M8.786,4.74h2.428v0.809H8.786V4.74z M16.879,15.26H3.122v-4.046h5.665v1.201c0,0.223,0.182,0.404,0.405,0.404h1.618c0.222,0,0.405-0.182,0.405-0.404v-1.201h5.665V15.26z M9.595,9.583h0.81v2.428h-0.81V9.583zM16.879,10.405h-5.665V9.19c0-0.222-0.183-0.405-0.405-0.405H9.191c-0.223,0-0.405,0.183-0.405,0.405v1.215H3.122V6.358h13.757V10.405z" fill="#6C757D" />
</svg>')
->nickname('post_job_request')
->data('permission', 'post job audio service');
