            ...
            <div class="d-flex align-items-center">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list align-items-center">
                        ...
                        <li class="nav-item nav-icon dropdown">
                            <a href="{{url('auth/chat')}}" class="search-toggle dropdown-toggle chat_notification_list"
                               id="chat-notification-dropdown">
                                <svg fill="#8f9fbb" width="25" height="25" class="h-6 w-6 text-secondary"
                                ...
                                <span class="bg-primary"></span>
                                <span class="badge badge-pill badge-danger badge-up chat_notify_count count-mail d-none"></span>
                                <span class=" dots d-none"></span>
                            </a>
                        </li>
