                    ...
                    <div class="card-body">
                        {{ Form::model($subcategory,['method' => 'POST','route'=>'subcategory.store', 'enctype'=>'multipart/form-data', 'data-toggle'=>"validator" ,'id'=>'subcategory'] ) }}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    {{ Form::label('name', __('messages.department_type',[ 'select' => __('messages.department_type') ]),['class'=>'form-control-label'],false) }}
                                    <br/>
                                    {{ Form::select('type_ids[]', ['' => ''] + $departmentTypeData->pluck('name', 'id')->toArray() , $deptType, [
                                                'class' => 'select2js form-group',
                                                'id' => 'type_ids',
                                                'multiple' => 'multiple',
                                                'data-placeholder' => __('messages.select_name',[ 'select' => __('messages.department_type') ]),
                                            ]) }}
                                </div>
