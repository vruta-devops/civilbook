...
<div class="d-flex justify-content-end align-items-center">
    @if(!$subcategory->trashed())
        ...
        <a class="mr-2" href="{{ route('subcategory.create',['id' => $subcategory->id]) }}" title="{{ __('messages.update_form_title',['form' => __('messages.subcategory') ]) }}"><i class="fas fa-pen text-primary"></i></a>
        @endif
