                            ...
                            <div class="card total-revenue">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="d-flex flex-wrap justify-content-start align-items-center">
                                                <h4 class="mb-2 booking-text font-weight-bold">{{ getPriceFormat($data['wallet_balance'])}}</h4>
                                                <p class="mb-0 ml-3 text-danger font-weight-bold"></p>
                                            </div>
                                            <p class="mb-0 booking-text">{{ __('messages.total_name', ['name' => __('messages.wallet_balance')]) }}</p>
                                        </div>
                                        <div class="col-auto d-flex flex-column">
                ...
                <div class="card top-providers">
                    ...
                    <div class="card-body p-0">
                        <ul class="common-list list-unstyled">
                            @if (empty($data['dashboard']['$customer']))
                                <li>
