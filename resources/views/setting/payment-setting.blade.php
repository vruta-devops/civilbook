<div class="row">
    <div class="col-lg-12">
        <ul class="nav nav-tabs pay-tabs nav-fill tabslink" id="tab-text" role="tablist">
            ...
            <li class="nav-item payment-link">
                <a href="javascript:void(0)" data-href="{{ route('payment_layout_page') }}?tabpage=paytm" data-target=".payment_paste_here" data-toggle="tabajax"  class="nav-link  {{$tabpage=='paytm'?'active':''}}"   rel="tooltip"> {{__('messages.paytm')}}</a>
            </li>
            <li class="nav-item payment-link">
                <a href="javascript:void(0)" data-href="{{ route('payment_layout_page') }}?tabpage=cashfree" data-target=".payment_paste_here" data-toggle="tabajax"  class="nav-link  {{$tabpage=='cashfree'?'active':''}}"   rel="tooltip"> {{__('messages.cashfree')}}</a>
            </li>
            <li class="nav-item payment-link">
                <a href="javascript:void(0)" data-href="{{ route('payment_layout_page') }}?tabpage=instamojo" data-target=".payment_paste_here" data-toggle="tabajax"  class="nav-link  {{$tabpage=='instamojo'?'active':''}}"   rel="tooltip"> {{__('messages.instamojo')}}</a>
            </li>
            <li class="nav-item payment-link">
