    ...
    <div class="row ">
        <div class="col-md-3">
            <div class="user-sidebar">
                <div class="user-body user-profile text-center" style="display: flex; flex-wrap: wrap">
                    <div class="user-img">
            ...
            <div class="user-content">
                ...
                <div class="row ">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        {{ Form::text('username',old('username'),['placeholder' => __('messages.username'),'class' =>'form-control','required', 'disabled']) }}
                        <small class="help-block with-errors text-danger"></small>
                    </div>
                    ...
                    @if($user_data->user_type =='provider')
                        ...
                        <div class="form-group col-md-12">
                            {{ Form::label('known_language', __('messages.known_language').'', ['class' => 'form-control-label'], false) }}
                            {{ Form::select('known_languages[]',[ array_combine($user_data->known_languages, $user_data->known_languages) ],$user_data->known_languages,[
									'class' => 'select2js form-group known_language',
									'id' =>'known_language',
                                    'multiple' => 'multiple',
                                    'data-tags' => 'true',
									'data-placeholder' => __('messages.known_language')
								]) }}
                        </div>

                        <div class="form-group col-md-12">
                            {{ Form::label('essential_skills', __('messages.essential_skill').'', ['class' => 'form-control-label'], false) }}
                            {{ Form::select('essential_skills[]',[ array_combine($user_data->essential_skills, $user_data->essential_skills) ],$user_data->essential_skills,[
									'class' => 'select2js form-group essential_skills',
									'id' =>'essential_skills',
                                    'multiple' => 'multiple',
                                    'data-tags' => 'true',
									'data-placeholder' => __('messages.known_language')
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {{ Form::text('title', null, ['placeholder' => __('messages.title'), 'class' => 'form-control' ]) }}
                        <small class="help-block with-errors text-danger"></small>
                    </div>
