...
class SubCategoryController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $subcategory = SubCategory::with(['departmentTypes'])->find($id);
        ...
        $deptType = $subcategory->departmentTypes->pluck('id');
        $departmentTypeData = Type::get(['id', 'name']);

        return view('subcategory.create', compact('pageTitle', 'subcategory', 'auth_user', 'departmentTypeData', 'deptType'));
    }
