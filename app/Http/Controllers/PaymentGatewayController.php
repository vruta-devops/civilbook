...
class PaymentGatewayController extends Controller
{
    ...
    public function paymentsettingsUpdates(Request $request){
        ...
        switch ($type) {
            case 'cashfree':
                $config_data = [
                    'cashfree_url' => $data['cashfree_url'],
                    'cashfree_app_secreat_key' => $data['cashfree_app_secreat_key'],
                    'cashfree_app_id' => $data['cashfree_app_id']
                ];
                break;
            case 'instamojo':
                $config_data = [
                    'instamojo_url' => $data['instamojo_url'],
