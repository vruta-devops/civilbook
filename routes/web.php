...
Route::group(['prefix' => 'auth'], function () {
    ...
    Route::get('conversations/{userId}', [ChatController::class, 'getConversations'])->name('conversations');
    Route::post('messages', [ChatController::class, 'addMessage'])->name('messages');
});
...
//    Route::group(['middleware' => ['permission:category']], function () {
    ...
    Route::post('department-status-update', [DepartmentController::class, 'updateStatus'])->name('departmentStatus.update');
    ...
    Route::get('department-types-index-data', [DepartmentTypeController::class, 'index_data'])->name('department-types.index_data');
//    Route::post('department-types-bulk-action', [\App\Http\Controllers\DepartmentTypeController::class, 'bulk_action'])->name('department-types.bulk-action');
//    Route::post('department-types-status-update', [\App\Http\Controllers\DepartmentTypeController::class, 'updateStatus'])->name('department-typesStatus.update');
//    Route::post('department-types-save', [\App\Http\Controllers\DepartmentTypeController::class, 'store'])->name('department-types.save');
//    Route::post('department-types-action', [\App\Http\Controllers\DepartmentTypeController::class, 'action'])->name('department-types.action');
...
//    Route::group(['middleware' => ['permission:service list']], function () {
    ...
    Route::get('pending-service', [ServiceController::class, 'pendingList'])->name('service.pending-service');

    Route::get('pending-service-index-data', [ServiceController::class, 'pendingListData'])->name('service.pending-service-index-data');
...
//    });
    ...
    Route::get('chat-notification-counts', [NotificationController::class, 'chatNotificationCounts'])->name('chat-notification.counts');
...
//    });
    ...
    Route::resource('wallet-withdraw', WalletWithdrawController::class);
...
//    Route::group(['middleware' => ['permission:postjob list']], function () {
    ...
    Route::get('audio-service-list', [ServiceController::class, 'getAudioServiceList'])->name('service.audio-service-list');
    Route::post('audio-service/{id}', [ServiceController::class, 'audioServiceDestroy'])->name('service.audio-service-destroy');
    Route::post('audio-service-action', [ServiceController::class, 'audioServiceAction'])->name('service.audio-service-action');
    Route::get('audio-service-post/{id}', [ServiceController::class, 'audioServicePost'])->name('service.audio-service-post');
    Route::post('audio-service-post-save', [ServiceController::class, 'audioServicePostSave'])->name('service.audio-service-post-save');
...
//    Route::group(['middleware' => ['permission:servicepackage list']], function () {
    ...
    Route::get('servicepackage/list/{packageid?}/{type?}', [ServiceController::class, 'index'])->name('servicepackage.service');
