...
Route::get('department-list', [API\DepartmentController::class, 'getDepartmentList']);
...
Route::get('search-services', [API\CommanController::class, 'getSearchServices']);
...
Route::post('web-login', [API\User\UserController::class, 'socialLoginWeb']);
Route::post('email-login', [API\User\UserController::class, 'emailLoginWeb']);
...
Route::group(['middleware' => ['auth:sanctum']], function () {
    Route::post('send-chat-notification', [API\CommanController::class, 'sendChatNotification']);
    Route::post('report-user', [API\User\UserController::class, 'reportUser']);
    Route::post('update-player-id', [API\User\UserController::class, 'updatePlayerId']);

    Route::get('wallet-withdraw', [API\WalletController::class, 'walletWithdrawList']);
    Route::post('wallet-withdraw', [API\WalletController::class, 'walletWithdraw']);

    Route::post('agora-token', [API\AgoraController::class, 'tokenGenerate']);
    ...
    Route::get('tax-list', [API\CommanController::class, 'taxList']);
    ...
    Route::get('coupons/services', [API\CouponController::class, 'serviceList']);
    Route::apiResource('coupons', API\CouponController::class)->except(['update', 'edit']);
    ...
    Route::post('get-audio-service-request', [API\PostJobRequestController::class, 'getAudioServiceRequestList']);
    Route::post('audio-service-delete/{id}', [App\Http\Controllers\ServiceController::class, 'audioServiceDestroy']);
    ...
    Route::post('bid-comments', [API\PostJobBidController::class, 'bidComments']);
...
Route::get('other-configurations', [API\DashboardController::class, "otherConfigurations"]);
